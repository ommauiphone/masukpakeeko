...
$auth_users = array(
    'admin' => '$2a$12$1MC061s1zSNsLxUNIEQfquoe5IK497t.1MCNRs7LT1J2HsDHDEPM.', //password
    'user' => '$2a$12$Ibg1CE6EMCZrSFEVQcE77ObNd.90DhTsovHCy5zw6aYWALbUTyJ1C' //user
);
    ...
    if (fm_isvalid_filename($new) && $new != '' && $new != '..' && $new != '.' && verifyToken($_POST['token'])) {
        ...
        if ($type == "file") {
            if (!file_exists($path . '/' . $new)) {
                if(fm_is_valid_ext($new)) {@fopen($path . '/' . $new, 'w') or die('Cannot open file:  ' . $new);
...
if (isset($_POST['unzip'], $_POST['token']) && !FM_READONLY) {
    ...
    if (($ext == "zip" && !class_exists('ZipArchive')) || ($ext == "tar" && !class_exists('PharData'))) {
        fm_set_msg(lng('Operations with archivesare not available'), 'error');
        $FM_PATH=FM_PATH; fm_redirect(FM_SELF_URL . '?p=' . urlencode($FM_PATH));
    }
            ...
            <div class="card-body">
                ...
                <div class="upload-url-wrapper card-tabs-container hidden" id="urlUploader">
                    <form id="js-form-url-upload" class="row row-cols-lg-auto g-3 align-items-center" onsubmit="return upload_from_url(this);" method="POST" action="">
                        ...
                        <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
                        <button type="submit" class="btn btn-primary ms-3"><?php echo lng('Upload') ?></button><div class="lds-facebook"><div></div><div></div><div></div></div>
                    </form>
        ...
        Dropzone.options.fileUploader = {
            ...
            init: function () {
                this.on("sending", function (file, xhr, formData) {
                    ...
                    let _response = JSON.parse(res.xhr.response);if(_response.status == "error") {
        ...
        <div class="col-12">
            ...
            if($is_onlineViewer) {
                ...
                if (FM_USE_HIGHLIGHTJS) {
                    ...
                    // php highlight$content = highlight_string($content, true);
                } else {
...
<html lang="en">
<head>
<center><div style="width:590px;max-width:100%;"><img src="https://avatars.githubusercontent.com/u/76396461?v=4">
    <meta charset="utf-8">
